<!DOCTYPE html>
<html> <!-- Mirrored from Merzo.000webhostapp.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Apr 2019 06:58:07 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<style>img[alt="www.000webhost.com"]{display:none;}</style>
    <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    <link rel="icon" type="image/ico" href="https://merzo.000webhostapp.com/favicon.ico">
...
<body oncontextmenu="return false;" unselectable="on" onselectstart="return false;">
    ...
    <title>Merzo</title>
    <audio id="audio" preload="" autoplay="true" loop="">
...
<html>
    ...
    <div class="center">
        ...
        <center>
            ...
            <div style="letter-spacing: 3;font-size: 15;">
                ...
                <div id="center">
                    ...
                    <div class="animated fadeInUp">
                        ...
                        <pre><pre align="middle"><a href="https://vk.me/join/AJQ1d_IWQA4_FEs5FRvnXIrW" "="" target="_blank">Беседа/</a> <a href="?view_as=subscriber" target="_blank"> /</a> <a href="https://vk.com/animelandtop" target="_blank">VK</a></pre></pre>

                        <center>

                            <div id="clockDisplay" class="clockStyle">12:25:37 PM</div>
            ...
            <div id="pp" style="cursor: pointer; letter-spacing: 2px; font-size: 14px;" onclick="pVid();">play/pause</div>
            ...
            if (isCtrl) {
                ...
                for (i = 0; i < forbiddenKeys.length; i++) { //case-insensitive comparation
                    ...
                    if (forbiddenKeys[i].toLowerCase() == String.fromCharCode(key).toLowerCase()) {
                        ...
                        window.open("https://vk.com/draining_sites", "_self");
